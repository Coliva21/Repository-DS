...
<div class="card">
    <div class="card-header text-right">
        <a class="btn btn-success btn-sm "  href="{{ url('usuarios/create') }}">Nuevo Registro</a>
    </div>
    <div class="card-body" >
                    ...
                    @foreach ($usuarios as $usuarios)
                        <tr>
                            ...
                            <td class="text-center">
                                <a href="{{ url('/usuarios/' . $usuarios->id . '/edit') }}" class="btn btn-warning btn-sm fa-regular fa-pen-to-square"></a>

                                <form action="{{ url('/usuarios/'. $usuarios->id) }}" class="d-inline user-delete" method="post">
                                    @csrf
                                    {{ method_field('DELETE') }}
...
@section('js')
    ...
    <!--JS local -->
    <script src="{{asset("vendor/adminlte/dist/js/user_app.js")}}"></script>
